...
tr_datagen = image.ImageDataGenerator(
    ...
    width_shift_range = 0.20,                # Float. Range for random horizontal shifts
    height_shift_range = 0.20,               # Float. Range for random vertical shifts
...
checkpointer = ModelCheckpoint(filepath = "theweights_xception.hdf5", verbose = 1, save_best_only = True, monitor = 'val_loss')
tb = TensorBoard(log_dir='./logs/'+ current, histogram_freq=0, write_graph=True, write_images=False)
